...
GitHub Pages liefert `index.html` (Repo-Wurzel) als öffentliche Website aus — der Link ist mit
Freunden teilbar.
...
4. Fertig — die Seite liegt unter `https://blsports.github.io/` und aktualisiert
